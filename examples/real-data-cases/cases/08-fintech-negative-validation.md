# 08 · Privacy-Preserving Complaint Monitoring and Negative Validation
...
![Held-out cumulative gain curve compared with random complaint review](../figures/08-negative-validation.svg)
...
| Valid terminal output | do_not_deploy ranking model |
...
- **Version:** Closed 2022 UTC window; privacy-minimized extract created 2026-07-27
- **Accessed:** 2026-07-27
- **License:** CC0
- **Analytical grain:** one 2022 complaint for a money-transfer, virtual-currency, or money-service product

# 06 · Treasury Yield-Curve Tail-Risk Engineering
...
![Historical expected shortfall across illustrative Treasury duration allocations](../figures/06-tail-risk.svg)
...
| Prepared rows | 1,500 |
| Valid terminal output | Risk-bounded duration comparison, not an investment instruction |

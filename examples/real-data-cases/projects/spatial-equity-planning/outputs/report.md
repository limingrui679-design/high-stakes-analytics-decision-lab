...
ACS tract indicators, complete-case composite need with median-imputation and legacy-route audits, spatial autocorrelation, heuristic five-hub allocation, bootstrap/sensitivity checks, and population-weighted nearest-MBTA-stop distance.
...
| config.parameters.rent_to_income_missing_policy | {'primary': 'complete_case_for_composite_need', 'sensitivity': 'observed_proxy_median_imputation', 'legacy_zero_fill': 'audit_only_not_used_for_decision'} | none | spatial-missingness-protocol | provisional_self_review | not_assigned | Complete-case and median-imputation agreement does not replace a stakeholder-approved missing-data policy. |
...
Composite need excludes missing rent-to-income proxies while retaining those tracts for non-composite analysis; tract internal points and straight-line distance remain planning screens, and land, zoning, networks, capacity, cost, and community consent are missing.
...
- Result SHA-256: `2666bffc0b0278a80e5b785bfdc48225f904e19300d57beca17afe9282a2c530`

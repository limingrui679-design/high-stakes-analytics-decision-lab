...
*Regulatory filing analytics and financial risk · Targeted filing review only · 3,000 modeled simulations*

## Executive Summary

- **Provisional preference — Review Top 10%.** It is the highest-ranked feasible option, with decision value score **88.7/100** and a modeled **100% probability of being best among decision-feasible alternatives**.
- **The lead is meaningful rather than absolute.** It leads the next feasible option, Review Top 20%, by **0.045 utility points**.
...
**Decision question:** Which transparent N-PORT review threshold should advance to analyst filing review?
...
## Review Top 10% leads on balanced value, not every dimension

**The preferred option earns its position through Filing-review workload, Average selected review score.** The comparison still exposes a trade-off on **no single modeled criterion**, so the decision should be presented as a transparent compromise rather than a universal optimum.
...
**Review Top 10% has expected utility 0.897, but its worst-decile average falls to 0.859.** The widest criterion-level uncertainty for this option is associated with **Internal high-score capture**, making it a priority for further evidence collection.
...
**The declared factor model gives Review Top 10% P(best) 100%, versus 100% under independent residuals and 100% under the stronger correlation stress.** Its CVaR10 moves from 0.859 independently to 0.859 under declared dependence and 0.859 under stress.
...
**The weakest modeled environment is Adverse transfer to a new setting, where the preferred option's risk-adjusted utility is 0.859.** The same feasible alternative remains ahead in every modeled scenario.
...
2. **Reduce uncertainty in Internal high-score capture.** Validate or replace the widest uncertainty input using experimental, quasi-experimental, observational, or engineering evidence appropriate to the domain.
...
|---:|---|:---:|---:|---:|---:|---:|---:|---|:---:|
| 1 | Review Top 10% | Yes | 88.7 | 0.897 | 0.859 | 100.0% | 100.0% | 0/3,000 observed; U95 0.00%; declared support excludes breach | Yes |
| 2 | Review Top 20% | Yes | 84.2 | 0.852 | 0.813 | 0.0% | 0.0% | 0/3,000 observed; U95 0.00%; declared support excludes breach | No |
| 3 | Baseline: Review Top 5% | Yes | 69.6 | 0.702 | 0.678 | 0.0% | 0.0% | 0/3,000 observed; U95 0.00%; declared support excludes breach | Yes |
...
|---|---:|---:|---:|---:|---:|
| Internal high-score capture | 45.0% | 0.98 share | 0.92 share–1 share | 0.980 | 0.0% |
| Filing-review workload | 35.0% | 0.102 share | 0.1 share–0.108 share | 0.898 | 0.0% |
| Average selected review score | 20.0% | 0.707 percentile index | 0.664 percentile index–0.722 percentile index | 0.707 | 0.0% |
...
|---|---:|---:|---:|---:|---:|
| Internal high-score capture | 45.0% | 0.98 share | 0.92 share–1 share | 0.980 | 0.0% |
| Filing-review workload | 35.0% | 0.204 share | 0.2 share–0.216 share | 0.796 | 0.0% |
| Average selected review score | 20.0% | 0.662 percentile index | 0.621 percentile index–0.675 percentile index | 0.662 | 0.0% |

#### Baseline: Review Top 5%

| Criterion | Weight | Mean | P05–P95 | Normalized score | Scale clipping |
|---|---:|---:|---:|---:|---:|
| Internal high-score capture | 45.0% | 0.49 share | 0.46 share–0.5 share | 0.490 | 0.0% |
| Filing-review workload | 35.0% | 0.051 share | 0.05 share–0.054 share | 0.949 | 0.0% |
| Average selected review score | 20.0% | 0.745 percentile index | 0.699 percentile index–0.76 percentile index | 0.745 | 0.0% |

### Correlation sensitivity

| Dependence state | Modeled winner | Recommended option P(best) | CVaR10 | Breach U95 |
|---|---|---:|---:|---:|
| Independent residuals | Review Top 10% | 100.0% | 0.859 | 0.00% |
| Declared factor model | Review Top 10% | 100.0% | 0.859 | 0.00% |
| Loading stress ×1.35 | Review Top 10% | 100.0% | 0.859 | 0.00% |
...
|---|---|---|---|---|
| `sec-nport-filing-review-analysis-output` | reproducible_project_output | Original publisher and repository analysis author | exploratory | 1. model_author (approved) |
...
- U.S. Securities and Exchange Commission. Form N-PORT Data Set 2025 Q4, minimized to fund-level review indicators.
- projects/sec-nport-filing-review/outputs/results.json
...
- Case SHA-256: `2a1abfef1f11e70a3281e9b7df2ef3707ce40f680175bc7ba879de44acd7c9a4`
